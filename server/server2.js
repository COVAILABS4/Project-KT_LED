...
const port = 5000;
// Method to get data from data1.json
const get_data = () => {
  try {
...
app.post("/import", upload.single("file"), (req, res) => {
  ...
  try {
    ...
    // Save updated data back to data1.json
    set_data(cache);
...
// Method to set data in data1.json
const set_data = (newData) => {
  try {
    fs.writeFileSync("./data1.json", JSON.stringify(newData, null, 2), "utf8");
